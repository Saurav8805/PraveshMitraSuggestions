...
const generateThankYouEmail = (userData) => {
  const { fullName, mhtCetScore, jeeScore, branches, cities, percentileRange, documentLink, documentName } = userData;
...
<body>
  <div class="container">
    ...
    <div class="summary-box">
      ...
      ${percentileRange ? `
      <div class="summary-row">
        <span class="summary-label">Percentile Range</span>
        <span class="summary-value">${percentileRange}%</span>
      </div>
      ` : ''}
    </div>
